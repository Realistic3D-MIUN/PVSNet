...
def process_image(img, video_type, radius, num_frames, num_loops, dataset, resolution, architecture):
    ...
    engine_name = f"checkpoint_{dataset_prefix}_{arch_infix}_{resolution}_fp16.engine"
    ...
    img_input_tensor = transform(img_input).unsqueeze(0)
    ...
    for x, y, z in trajectory:
        ...
        p_img = results['output_image'][0] # (3, H, W)
        p_img = p_img.transpose(1, 2, 0) # (H, W, 3)
